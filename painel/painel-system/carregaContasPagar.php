  ...
  if ($mesAtual == $mesConta){
    ...
    if ($status==1){
      ...
      <tr>
        ...
        <td style='vertical-align: middle;' class='center'><font size='3px'><i class='fa fa-check fa-fw'></i> Pago</font></td>
          ...
          <div class='modal fade' id='edit$id' tabindex='-1' role='dialog' aria-labelledby='myModalLabel'>
            <div class='modal-dialog' role='document'>
              <div class='modal-content'>
                ...
                <form action='painel-system/editarConta.php?tipo=P' method='POST' role='form'>
                  <input type='hidden' name='id' value='$id'>
                  <div class='modal-body'>
                    ";
                    include("camposEditarContaP.php");
                    echo"
                  </div>
                  <div class='modal-footer'>
                    <button type='button' class='btn btn-default' data-dismiss='modal'>Cancelar</button>
      ...
      <tr>
        ...
        <td style='vertical-align: middle;'><font size='3px'>R$$valor</font></td>
        <td style='vertical-align: middle;'><font size='3px'>"; echo date('d/m/Y', strtotime($data)); echo"</font></td>
        <td style='vertical-align: middle;' class='center'><font size='3px'><i class='fa fa-times fa-fw'></i> Não pago</font></td>
        <td style='vertical-align: middle;' align='center'>
          <a data-toggle='modal' data-target='#exc$id'>
            <font color='#d9534f'><i class='fa fa-remove btn btn-danger'></i></font>
          </a>
...
<div class='col-lg-12' align='center'>
  <div class='panel panel-default col-lg-4'>
    ...
    <div class='panel panel-default col-lg-4'>
      ...
      ";
      echo "<div class='col-lg-12' align='center'><a href='painel-system/contas_a_pagar.php' class='btn btn-primary' target='_blank'>Gerar Arquivo PDF</a><br></div><br><br>";
      ?>